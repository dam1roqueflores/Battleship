...
public class ControladorJuego {
    ...
    ControladorIA controladorMaquina;
    ...
    private void controlEstadoJugando() {
        ...
        if (turno == TURNO_ALIADO) {
            ...
            if (recienTocado) {
                ...
                //Si ha tocado en el tablero

                //Si me ha tocado en el tablero enemmigo que llame a tablero para que vea si está
                //pulsado anteriormente o no

                //si es falso y hemos pinchado agua, que cambie el turno y vuelve al principio de
                //if turno
            ...
            if (pasos == 120) {
                if (!controladorMaquina.juega(misTableros.get(1).comprobarDisparo(Gdx.input.getX(),Gdx.input.getY()))) {
                    turno = TURNO_ALIADO;
                }
                pasos = 0;
            } else {
